...
public static class PreferencesHelpers
{
    public static T Get<T>(string key, T @default) where T : class
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"Error al deserializar el valor de los ajustes: {ex}");
        }
        return result;
    }
    ...
    public static void Set<T>(string key, T obj) where T : class
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"Error al serializar el valor de los ajustes: {ex}");
        }
    }
