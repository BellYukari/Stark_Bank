...
public partial class StatisticsViewModel : ObservableObject
{
    ...
    private void WeekData()
    {
        ...
        {
             new PieSeries<int> { Name = "Envios", Values = new List<int> { 10 }, InnerRadius = 80 },
            new PieSeries<int> { Name = "Recarga", Values = new List<int> { 6 }, InnerRadius = 80 },
            new PieSeries<int> { Name = "Tarjeta Virtual", Values = new List<int> { 3 }, InnerRadius = 80 },
            new PieSeries<int> { Name = "Admin", Values = new List<int> { 2 }, InnerRadius = 80 },
            new PieSeries<int> { Name = "servicios Públicos", Values = new List<int> { 2 }, InnerRadius = 80 },
        };
    }
